  ...
  return (
    <section className="space-y-6">
      <div className={'rounded-lg border border-line bg-surface p-6 text-left'}>
        <h2 className={'mb-4 text-left text-xl font-semibold text-ink'}>{t('options_general_header')}</h2>

        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_maxSteps')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_maxSteps_desc')}</p>
            </div>
            ...
            <input
              ...
              className={
                'w-20 rounded border border-line bg-surface px-3 py-2 text-ink focus:border-amber focus:outline-none'
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_maxActions')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_maxActions_desc')}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_maxFailures')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_maxFailures_desc')}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_enableVision')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_enableVision_desc')}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_displayHighlights')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_displayHighlights_desc')}</p>
            </div>
            <div className="relative inline-flex cursor-pointer items-center">
              <input
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_planningInterval')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_planningInterval_desc')}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_minWaitPageLoad')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_minWaitPageLoad_desc')}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={'text-base font-medium text-ink'}>{t('options_general_replayHistoricalTasks')}</h3>
              <p className={'text-sm font-normal text-muted'}>{t('options_general_replayHistoricalTasks_desc')}</p>
            </div>
            <div className="relative inline-flex cursor-pointer items-center">
              <input
